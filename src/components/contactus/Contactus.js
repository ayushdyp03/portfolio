              ...
              <Row>
                ...
                <Col md={7}>
                  <div className="contacts-details">
                    <a
                      href={`mailto:shreenidhivedpathak120@gmail.com`}
                    ...
                    >
                      ...
                      <p style={{ color: "#fbd9ad" }}>
                        shreenidhivedpathak120@gmail.com
                      </p>
                    </a>
                    <a
                      href={`Mobile:+91 9923466132`}
                      className="personal-details"
                    >
                      <div className="detailsIcon">
                        <FiPhone />
                      </div>
                      <p style={{ color: "#fbd9ad" }}>+91 9923466132</p>
                    </a>
                    <a
                      href="https://maps.app.goo.gl/LAHSMhRiJeja1XM47"
                      className="personal-details"
                    >
                      <div className="personal-details">
                        ...
                        <p style={{ color: "#fbd9ad" }}>
                        Sant Tukaram Nagar, Pimpri Colony, Pune, Pimpri-Chinchwad, Maharashtra 411018
                        </p>
                      </div>
                    </a>
                  </div>
                  <div className="contact-map">
                    <iframe
                      src="https://maps.app.goo.gl/LAHSMhRiJeja1XM47"
                      frameBorder="0"
                      allowFullScreen=""
                      aria-hidden="false"
                      title="Contact Me"
